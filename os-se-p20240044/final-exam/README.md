# Final Exam — <YOUR FULL NAME HERE>
...
Date & start time: 2026-06-30, <YOUR ACTUAL START TIME HERE>
...
- **Why did the unpatched `swarm` sometimes leave more stock than the correct final
  ...
  Time-of-Check-to-Time-of-Use race, fixed in D3 with flock.)

**Anything not completed:** none — race reproduced as both over-stock and negative-stock
outcomes across runs; D3's lock is what's graded and works correctly every run.
...
**Anything not completed:** <fill in once E2/E3 cron jobs are confirmed firing and
cron_report.txt is saved>
